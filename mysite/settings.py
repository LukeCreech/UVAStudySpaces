...
uri_parts = urlparse(DATABASE_URI)

DATABASE_USER = uri_parts.username
DATABASE_PASSWORD = uri_parts.password
DATABASE_HOST = uri_parts.hostname
DATABASE_PORT = uri_parts.port
